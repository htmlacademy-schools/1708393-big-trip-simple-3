...
import {getOffersByType, getOfferName} from '../mock/data';
import {getDateYears, createOffersTemplate} from '../utils';
  ...
  return (
    ...
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input event__input--time" id="event-start-time-${point.id}" type="text" name="event-start-time" value="${getDateYears(point.dateFrom)}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-${point.id}">To</label>
        <input class="event__input event__input--time" id="event-end-time-${point.id}" type="text" name="event-end-time" value="${getDateYears(point.dateTo)}">
      </div>
...
export default class EditingForm extends AbstractStatefulView{
  ...
  #eventTypeHandler = (evt) => {
    ...
    this.updateElement({
      ...
      offers: getOffersByType.find((offer) => offer.type === evt.target.value).offers.map((offer) => offer.id),
      currentTypeOffers: getOffersByType.find((offer) => offer.type === evt.target.value).offers
    });
  };
  ...
  static parsePointToState(point) {
    return {...point,
      currentTypeOffers: getOffersByType.find((offer) => offer.type === point.type).offers
    };
  }
